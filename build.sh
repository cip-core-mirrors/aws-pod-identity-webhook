...
opt_push=$1
IMG_NAME="quay.io/cip-core-platform/pod-identity-webhook"
...
RUNTIME_OS_RELEASE=$(docker run -it --rm $RUNTIME_IMAGE grep PRETTY_NAME /etc/os-release | cut -d= -f2 | sed -e 's/"//g' -e 's/\r//')
...
docker build -t $IMG_NAME:$IMG_TAG \
             ...
             --label io.cip.runtime-os-release="$RUNTIME_OS_RELEASE" \
